...
import DefaultController from '../DefaultPublicController.jsx'
	...
	render(){
		...
		return(
			<div className="jumbotron container">
			  	<h1 className="display-3">React 16  , Bootstrap 4 Bolerplate</h1>
			  	...
			  	<p>Before clone the respository <code>{"git clone " + this.author.repositoryLink}</code></p>
